...
const pricingSchema = z.object({
  ...
  profitMargin: z.number().min(0), // Can be calculated? Required by schema
  discount: z.object({
...
export const productZodSchema = z.object({
  ...
  primaryCategory: objectIdSchema.optional(), // Can verify if in categories
