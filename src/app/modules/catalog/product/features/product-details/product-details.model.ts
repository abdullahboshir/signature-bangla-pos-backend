...
import { PhysicalPropertiesSchema, ProductAttributesSchema } from "../../product-shared/product-shared.model.ts";
import type { IProductDetails } from "./product-details.interface.ts";
