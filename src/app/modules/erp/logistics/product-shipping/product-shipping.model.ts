...
import type { IProductShippingDocument } from "./product-shipping.interface.ts";
import { DeliveryOptionsSchema, PhysicalPropertiesSchema } from "@app/modules/catalog/index.ts";
